export const MENU = {
  BN: {
    ...
    ORANIZATION_TYPE_LIST: "প্রতিষ্ঠানের ধরণের তালিকা",
    ORANIZATION_TYPE_TREE: "প্রতিষ্ঠানের ধরণের ট্রি",
  ...
  EN: {
    ...
    ORANIZATION_TYPE_LIST: "Organization Type List",
    ORANIZATION_TYPE_TREE: "Organization Type Tree",
