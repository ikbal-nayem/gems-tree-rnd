...
export const ROUTE_L2 = {
  ...
  OMS_ORGANOGRAM_NODE_LIST: ROUTE_L1.OMS_ORGANOGRAM + "/organogram-node-list",
  ...
  OMS_ORGANIZATION_BUSINESS_OF_ALLOCATION: ROUTE_L1.OMS_ORGANIZATION + "/business-of-allocation",
